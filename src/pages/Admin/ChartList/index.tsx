...
import { Button, message, Popconfirm, Tag, Tooltip, Typography, Space } from 'antd';
...
import UpdateChartModal from '@/pages/Admin/ChartList/components/UpdateChartModal';
    ...
    },
    {
      ...
      render: (_, record) => {
        const statusMap: Record<string, { color: string; text: string }> = {
          ...
          succeed: { color: 'success', text: '成功' },
          failed: { color: 'error', text: '失败' },
        };
        const status = statusMap[record.status!] || statusMap.wait;
